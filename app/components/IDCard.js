...
const IDCard = (props) => {
  ...
  return (
    <a target="_blank" href={`https://www.${url}`}>
      <div className="flex max-w-xl  max-h-20 m-6 p-4 mx-auto bg-card-background hover:bg-card-highlight border-border-dark border-2  shadow rounded-md space-x-4">
        <div className="w-1/4">
